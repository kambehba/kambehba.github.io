...
var AppComponent = /** @class */ (function () {
    ...
    AppComponent.prototype.hideAllNav = function () {
        this.showNav = false;
        this.showNav2 = false;
        this.showNav3 = false;
        this.showNav4 = false;
    ...
    AppComponent.prototype.ShowExperince = function (level) {
        this.hideAll();
        switch (level) {
            case 'e1':
    ...
    AppComponent.prototype.showEducation = function (educationOption) {
        this.hideAll();
    ...
    AppComponent.prototype.Showskill = function (skillsOption) {
        this.hideAll();
        switch (skillsOption) {
            case 's1': {
    ...
    AppComponent.prototype.Showinterest = function (interestOption) {
        this.hideAll();
    ...
    AppComponent.prototype.back = function (option) {
        this.hideAll();
        this.hideAllNav();
        this.showNav = true;
        this.showAbout = true;
    };
    AppComponent.prototype.backFromExperience = function () {
        this.hideAll();
        this.showNav = true;
        this.showNav2 = false;
        this.showNav3 = false;
